...
class Model(Base):
    ...
    rON_B = Column(Float(53))  # 隔夜拆放买入价
    rON_A = Column(Float(53))  # 隔夜拆放卖出价
    r1W_B = Column(Float(53))  # 1周买入
    r1W_A = Column(Float(53))  # 1周卖出
    r2W_B = Column(Float(53))  # 买入
    r2W_A = Column(Float(53))  # 卖出
    r1M_B = Column(Float(53))  # 买入
    r1M_A = Column(Float(53))  # 卖出
    r3M_B = Column(Float(53))  # 买入
    r3M_A = Column(Float(53))  # 卖出
    r6M_B = Column(Float(53))  # 买入
    r6M_A = Column(Float(53))  # 卖出
    r9M_B = Column(Float(53))  # 买入
    r9M_A = Column(Float(53))  # 卖出
    r1Y_B = Column(Float(53))  # 买入
    r1Y_A = Column(Float(53))  # 卖出
