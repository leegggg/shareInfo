...
class Model(Base):
    ...
    r1W = Column(Float)  # 1周拆放利率
    r2W = Column(Float)  # 2周拆放利率
    r1M = Column(Float)  # 1个月拆放利率
    r3M = Column(Float)  # 3个月拆放利率
    r6M = Column(Float)  # 6个月拆放利率
    r9M = Column(Float)  # 9个月拆放利率
    r1Y = Column(Float)  # 1年拆放利率
