...
class Model(Base):
    ...
    rzmre = Column(Integer)  # 融资买入额(元)
    rzye = Column(Integer)  # 融资余额(元)
    rqmcl = Column(Integer)  # 融券卖出量
    rqyl = Column(Integer)  # 融券余量
    rqye = Column(Integer)  # 融券余量(元)
    rzrqye = Column(Integer)  # 融资融券余额(元)
