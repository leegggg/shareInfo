...
class Model(Base):
    ...
    m2 = Column(Float(53))  # 货币和准货币（广义货币M2）(亿元)
    m2_yoy = Column(Float(53))  # 货币和准货币（广义货币M2）同比增长( %)
    m1 = Column(Float(53))  # 货币(狭义货币M1)(亿元)
    m1_yoy = Column(Float(53))  # 货币(狭义货币M1)同比增长( %)
    m0 = Column(Float(53))  # 流通中现金(M0)(亿元)
    m0_yoy = Column(Float(53))  # 流通中现金(M0)同比增长( %)
    cd = Column(Float(53))  # 活期存款(亿元)
    cd_yoy = Column(Float(53))  # 活期存款同比增长( %)
    qm = Column(Float(53))  # 准货币(亿元)
    qm_yoy = Column(Float(53))  # 准货币同比增长( %)
    ftd = Column(Float(53))  # 定期存款(亿元)
    ftd_yoy = Column(Float(53))  # 定期存款同比增长( %)
    sd = Column(Float(53))  # 储蓄存款(亿元)
    sd_yoy = Column(Float(53))  # 储蓄存款同比增长( %)
    rests = Column(Float(53))  # 其他存款(亿元)
    rests_yoy = Column(Float(53))  # 其他存款同比增长( %)
